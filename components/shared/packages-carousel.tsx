...
import { Sparkles, Crown, Award, Star, Gem } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-8">
          {packages.map((pkg) => {
            ...
            return (
              <Card
                key={pkg.name}
                className="relative flex h-full flex-col overflow-hidden rounded-xl border border-border/70 bg-background py-0"
              >
                {pkg.popular && (
                  <>
