...
import { privacyContentData } from './data'
    ...
    <Section variant="muted">
      <Container>
        <Card>
          <CardHeader>
            <CardTitle>
              <h2 className="scroll-m-20 pb-2 text-3xl font-semibold tracking-tight first:mt-0 text-balance">{privacyContentData.title}</h2>
            </CardTitle>
