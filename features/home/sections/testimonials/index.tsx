          ...
          <Container size="sm">
            <div className="space-y-4">
              <Small className="text-primary uppercase tracking-[0.3em]">
                {homeTestimonialsData.subtitle}
              </Small>
              <H2>{homeTestimonialsData.title}</H2>
              <Lead>{homeTestimonialsData.description}</Lead>
            </div>
          </Container>
        </div>
        ...
        <div className="relative">
          ...
          >
            <CarouselContent className="-ml-0 md:-ml-4">
              {homeTestimonialsData.testimonials.map((testimonial) => (
